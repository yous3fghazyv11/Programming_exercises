...
double convert(std::string to_unit, std::string from_unit, double value)
{
    ...
    if (from_unit == "m") value_in_meters = value;
    else if(from_unit == "cm") value_in_meters = value * CM_M;
    else if(from_unit == "ft") value_in_meters = value * FT_M;
    else if(from_unit == "in") value_in_meters = value * IN_M;

    if (to_unit == "m") return value_in_meters;
    else if(to_unit == "cm") return value_in_meters / CM_M;
    else if(to_unit == "ft") return value_in_meters / FT_M; 
    else if(to_unit == "in") return value_in_meters / IN_M; 
    else return 0;
...
{
    std::cout << std::endl << std::endl << "values entered: " << GREEN << '[';
...
int main()
{
	...
	while (getting_input) { // main loop
        ...
        if (getting_input) {
            ...
            std::cout << output_values.back() << std::endl;
